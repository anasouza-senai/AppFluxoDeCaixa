...
namespace AppFluxoDeCaixa.Models
{
    public class Fornecedor
    {
        ...
        [MaxLength(11, ErrorMessage = " O Campo Telefone deve ter, no maximo, 11 Caracteres!")]
        [MinLength(10, ErrorMessage = "O Campo Telefone deve ter, no minimo, 10 Caracteres!")]
